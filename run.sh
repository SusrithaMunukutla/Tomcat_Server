...
cat << EOF > /opt/apache-tomcat-7.0.73/conf/tomcat-users.xml
...
if [ -f "/opt/apache-tomcat-7.0.73/webapps/manager/WEB-INF/web.xml" ]
then
...
exec /opt/apache-tomcat-7.0.73/bin/catalina.sh run
